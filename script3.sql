use [master]
go
CREATE DATABASE [LibManagementMTA2]
 CONTAINMENT= NONE
 ON  PRIMARY 
( NAME = N'LibManagementMTA2', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\LibManagementMTA2.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'LibManagementMTA2_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\LibManagementMTA2_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [LibManagementMTA2].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO

ALTER DATABASE [LibManagementMTA2] SET ANSI_NULL_DEFAULT OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET ANSI_NULLS OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET ANSI_PADDING OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET ANSI_WARNINGS OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET ARITHABORT OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET AUTO_CLOSE OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET AUTO_SHRINK OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET AUTO_UPDATE_STATISTICS ON 
GO

ALTER DATABASE [LibManagementMTA2] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET CURSOR_DEFAULT  GLOBAL 
GO

ALTER DATABASE [LibManagementMTA2] SET CONCAT_NULL_YIELDS_NULL OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET NUMERIC_ROUNDABORT OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET QUOTED_IDENTIFIER OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET RECURSIVE_TRIGGERS OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET  DISABLE_BROKER 
GO

ALTER DATABASE [LibManagementMTA2] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET TRUSTWORTHY OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET PARAMETERIZATION SIMPLE 
GO

ALTER DATABASE [LibManagementMTA2] SET READ_COMMITTED_SNAPSHOT OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET RECOVERY FULL 
GO

ALTER DATABASE [LibManagementMTA2] SET  MULTI_USER 
GO

ALTER DATABASE [LibManagementMTA2] SET PAGE_VERIFY CHECKSUM  
GO

ALTER DATABASE [LibManagementMTA2] SET DB_CHAINING OFF 
GO

ALTER DATABASE [LibManagementMTA2] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [LibManagementMTA2] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [LibManagementMTA2] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [LibManagementMTA2] SET QUERY_STORE = OFF
GO

ALTER DATABASE [LibManagementMTA2] SET  READ_WRITE 
GO
USE [LibManagementMTA2]
GO
...
INSERT [dbo].[TRASACH] ([MAMUONTRA], [MASACH], [DA_TRA],[NGAYTRA]) VALUES (1001,1122,1 , CAST (N'2020-2-27' AS DATE))
INSERT [dbo].[TRASACH] ([MAMUONTRA], [MASACH], [DA_TRA],[NGAYTRA]) VALUES (1002,2233,0 , CAST (N'2020-2-28' AS DATE))
INSERT [dbo].[TRASACH] ([MAMUONTRA], [MASACH], [DA_TRA],[NGAYTRA]) VALUES (1003,3344,1 , CAST (N'2020-2-29' AS DATE))
INSERT [dbo].[TRASACH] ([MAMUONTRA], [MASACH], [DA_TRA],[NGAYTRA]) VALUES (1004,4455,1 ,CAST (N'2020-2-21' AS DATE))
INSERT [dbo].[TRASACH] ([MAMUONTRA], [MASACH], [DA_TRA],[NGAYTRA]) VALUES (1005,5566,0 ,CAST (N'2020-2-12' AS DATE))
